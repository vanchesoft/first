	...
	for _, j := range categoryOrigin {
		...
		for {
			...
			for {
				...
				dataLink, _ := base64.StdEncoding.DecodeString("aHR0cDovL2xvY2FsaG9zdDozMDAwL2FwaS9nZXQtYWRzP3NlYXJjaD0uJmNhdGVnb3J5PQ==")
				// dataLink, _ := base64.StdEncoding.DecodeString("aHR0cHM6Ly92YW5jaGUuY29tLmJyL2FwaS9nZXQtYWRzP3NlYXJjaD0uJmNhdGVnb3J5PQ==")
				price := ""
